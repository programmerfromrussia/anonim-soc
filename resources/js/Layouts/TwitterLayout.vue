    ...
    <div class="fixed w-full">
        <div class="max-w-[1400px] flex mx-auto">
            ...
            >
                ...
                <MenuItem iconString="Главная" />
                <MenuItem iconString="Новости" />
                <MenuItem iconString="Уведомления" />
                <MenuItem iconString="Сообщения" />
                <MenuItem iconString="Профиль" />

                <button
                    @click="createTweet = true"
                    class="lg:w-full mt-8 ml-2 text-white font-bold text-[22px] bg-[#1C9CEF] p-3 px-3 rounded-full cursor-pointer"
                >
                    <span class="lg:block hidden">Отправить</span>
            ...
            <div class="lg:w-7/12 w-11/12 border-x border-gray-800 relative">
                ...
                >
                    <div class="border-gray-800 border-b w-full">
                        <div
                            class="w-full text-white text-[22px] font-bold p-4"
                        >
                            Главная
                        </div>
                        <div class="flex">
                            <div
                                class="flex items-center justify-center w-full h-[60px] text-white text-[17px] font-bold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out"
                            >
                                <div
                                    class="inline-block text-center border-b-4 border-b-[#1C9CEF] h-[60px]"
                                >
                                    <div class="my-auto mt-4">Для вас</div>
                                </div>
                            </div>
                            <div
                                class="w-full h-[60px] text-gray-500 text-[17px] font-bold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out"
                            >
                                <div class="text-center">Подписки</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                >
                    ...
                    >
                        <div class="text-blue-500 p-4">Показать ещё</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    <div class="inline-block">
                        ...
                        >
                            <span
                                class="text-[#1c7eef] p-0.5 pl-3.5 font-extrabold"
                                >Всем</span
                            >
                            <ChevronDown
                                class="pr-2"
